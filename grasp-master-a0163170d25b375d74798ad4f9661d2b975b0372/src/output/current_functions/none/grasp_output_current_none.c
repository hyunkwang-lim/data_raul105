...
#include "grasp_output_current_none.h"


grasp_output_current_function_t grasp_output_current_function_none(){
    grasp_output_current_function_t x;
    
    x.init=grasp_output_current_function_none_init;
    x.function=grasp_output_current_function_none_process;
    x.close=grasp_output_current_function_none_close;
