...
/* 
 * File:   grasp_output_segment_print_classic.h
 * Author: fuertes
 *
 * Created on September 7, 2014, 12:23 PM
 */

#ifndef GRASP_OUTPUT_SEGMENT_PRINT_CLASSIC_H
#define	GRASP_OUTPUT_SEGMENT_PRINT_CLASSIC_H
...
extern void grasp_output_segment_print_classic_f90_screen(retr_input *RIN, sensor_data_t *sdata,output_segment_general *ROUT);

extern void grasp_output_segment_print_classic_f90_file(char filename[_GBL_FILE_PATH_LEN], retr_input *RIN, sensor_data_t *sdata,output_segment_general *ROUT);
...
#endif	/* GRASP_OUTPUT_SEGMENT_PRINT_CLASSIC_H */
