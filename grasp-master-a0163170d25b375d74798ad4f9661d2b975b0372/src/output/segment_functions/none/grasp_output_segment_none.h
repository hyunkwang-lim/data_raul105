...
/* 
 * File:   grasp_output_segment_print_none.h
 * Author: fuertes
 *
 * Created on September 7, 2014, 12:24 PM
 */

#ifndef GRASP_OUTPUT_SEGMENT_PRINT_NONE_H
#define	GRASP_OUTPUT_SEGMENT_PRINT_NONE_H
...
#endif	/* GRASP_OUTPUT_SEGMENT_PRINT_NONE_H */
