...
<xsl:template name="chunk-element-content">
  ...
  <xsl:param name="content">
    ...
    <xsl:call-template name="user.preroot"/>
      ...
      <xsl:text disable-output-escaping="yes"><![CDATA[<?php
        ...
        get_header(); ?>]]></xsl:text>
      <link rel="stylesheet" id="docbook-custom-style" href="docbook-custom-style.css" type="text/css" media="all"></link>
      <div class="l-submain">
        <div class="g-html i-cf">
  ...
  <xsl:text disable-output-escaping="yes"><![CDATA[<?php get_footer(); ?>]]></xsl:text>
